...
void AuiSpdCyclicFunc(register struct CyclycNode *cyclicNode) {
  ...
  static struct AuiSpdRegisters *r = auiSpdRegisters;
  ...
  if (newSamples < 20000/10 || phase < 0) {
    ...
    s_int16 multiplier;
    phase = (phase + 1) & 3;
    multiplier = (phase & 2) ? 1/* 88.2 & 96 kHz */ : 2/* 44.1 & 48 kHz */;
    ...
    */
    ...
    s_int32 nd2 = newDiff;
    s_int32 ccf = (r->fmCcf << 6) - 50000*nd2;
