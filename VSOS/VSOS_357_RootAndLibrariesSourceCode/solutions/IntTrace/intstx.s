...
/*
   STX interrupt routine.
   Never call explicitly!
   This routine calls void IntStxC(void);

   Set the interrupt vector from C as follows:

   extern u_int16 IntStxVector;
   [...]
   WriteIMem((void *)(0x20+INTV_STX), ReadIMem((void *)(&IntStxVector)));
   ...
   PERIP(INT_ENABLE1_HP) &= ~INTF1_STX;
*/
	.sect code,IntStxVector
	.export _IntStxVector
_IntStxVector:
	jmpi _IntStxAsm,(i6)+1
