...
auto ioresult AudioSetHiBits(register u_int16 hiBits) {
  ...
  PERIP(I2S_CF) = (hiBits ? I2S_CF_32B : 0) | (I2S_CF_MASTER | I2S_CF_ENAMCK |
				              I2S_CF_MODE | I2S_CF_INTENA);
  PERIP(I2S_CF) = (hiBits ? I2S_CF_32B : 0) | (                I2S_CF_ENAMCK |
