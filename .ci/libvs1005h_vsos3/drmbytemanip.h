...
#define OUT
#define IN
typedef u_int16 DRM_WORD;
typedef s_int16 DRM_BYTE;
typedef char DRM_CHAR;
typedef u_int32 DRM_DWORD;
typedef s_int16 DRM_INT;
typedef u_int16 DRM_UINT;
...
DRM_NATIVE_BYTE DRM_API DRM_16B_Read8BitByte(
    register __a0 IN  const DRM_VOID *f_pv,
    register __a1 IN        DRM_WORD f_ib);
#else
DRM_NATIVE_BYTE DRM_API DRM_16B_Read8BitByte(
...
DRM_VOID DRM_API DRM_16B_Write8BitByte(
    register __a0 OUT DRM_VOID        *f_pv,
    register __a1 IN  DRM_WORD        f_ib,
    register __b0 IN  DRM_NATIVE_BYTE f_b);
DRM_VOID DRM_API DRM_16B_Xor8BitByte(
    register __a0 OUT DRM_VOID        *f_pv,
    register __a1 IN  DRM_WORD        f_ib,
    register __b0 IN  DRM_NATIVE_BYTE f_b);
#else
...
#define XOR_BYTE(pb,ib,b)            DRM_16B_Xor8BitByte((pb),(ib),(b))
...
#define MAKE_MACHINE_BYTE(b0,b1)   ((DRM_NATIVE_BYTE)(((b1)<<8)|((b0)&0x00FF)))
#else
...
#define XOR_BYTE(pb,ib,b)           (pb)[(ib)]^=(b)
