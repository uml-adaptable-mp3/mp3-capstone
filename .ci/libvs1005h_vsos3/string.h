...
__near void memcpyix(__near u_int16 register __i0 *d, 
		     __near const void register __i1 *s, 
		     size_t register __a0 n); /**< Copies n instruction words from s to d, where the source is I memory and destination is X memory. */
__near void memcpyxi(__near void register __i0 *d, 
		     __near const u_int16 register __i1 *s, 
		     size_t register __a0 n); /**< Copies n instruction words from s to d, where the source is X memory and destination is I memory. */
__near void memcpyiy(__near __mem_y u_int16 register __i0 *d, 
		     __near const void register __i1 *s, 
		     size_t register __a0 n); /**< Copies n instruction words from s to d, where the source is I memory and destination is Y memory. */
__near void memcpyyi(__near void register __i0 *d, 
		     __near __mem_y const u_int16 register __i1 *s, 
		     size_t register __a0 n); /**< Copies n instruction words from s to d, where the source is Y memory and destination is I memory. */
...
__mem_y __near void register __i0 *memmoveYY(__mem_y __near void register __i0 *s,
				   __mem_y const __near void register __i1 *ct,
				   unsigned short register __a0 n);
