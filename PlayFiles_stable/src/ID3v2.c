...
void ReturnID3(SongInfo **metadata)
{
    ...
    // Only gets here if for some reason it identified as ID3 but didn't report as v1 or v2, which wouldn't make sense
    // or all of the data was successfully retrieve and can be returned now
    return;// metadata;
}